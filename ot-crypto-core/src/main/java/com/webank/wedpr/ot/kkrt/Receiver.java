...
public class Receiver {
    ...
    public OtData step3InitMatrix(OtData otDataInput) {
        otDataInput =
                NativeInterface.step3ReceiverInitMatrix(receiverHandle, otDataInput, choiceCount);
        return otDataInput;
    }

    public OtResult step5GetResult(OtData otDataInput) {
        OtResult otResult =
                NativeInterface.step5ReceiverGetFinalResultWithDecMessage(
                        receiverHandle, otDataInput, choiceCount);
        return otResult;
    }
